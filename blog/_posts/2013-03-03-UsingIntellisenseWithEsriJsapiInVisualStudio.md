...
![Open Options Dialog]({{ site.blogImagesFolder }}{{ page.name }}/1-OpenOptionsDialog.png)  
...
![Prepare Javascript References]({{ site.blogImagesFolder }}{{ page.name }}/2-PrepareJsReferences.png)  
...
![Add New File]({{ site.blogImagesFolder }}{{ page.name }}/3-AddNewItem.png)  

Then, name the new file _references.js 

![Add Reference File]({{ site.blogImagesFolder }}{{ page.name }}/4-AddReferencesFile.png)  
...
![Content of Reference File]({{ site.blogImagesFolder }}{{ page.name }}/5-ContentOfReferenceFile.png)  
...
![Intellisense in VS 2012]({{ site.blogImagesFolder }}{{ page.name }}/6-EsriJsApiIntellisenseVS2012.png)  
...
![Adding Reference File in VS 2010]({{ site.blogImagesFolder }}{{ page.name }}/7-AddingReferenceFileInVS2010.png)  

You’ll get the same results.        

![Intellisense in VS 2010]({{ site.blogImagesFolder }}{{ page.name }}/8-EsriJsApiIntellisenseVS2010.png)  
