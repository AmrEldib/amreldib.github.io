...
---
<img class="imageOnRight" src="{{ site.imagesFolder }}{{ page.name }}/VirtualBox.png">
<img class="imageOnRight" src="{{ site.imagesFolder }}{{ page.name }}/VMware.png">
...
<figure class="imageInCenter">
    <a href="{{ site.imagesFolder }}{{ page.name }}/TwoUpdateWindowsSmall.png">
        <img class="imageInCenter" src="{{ site.imagesFolder }}{{ page.name }}/TwoUpdateWindowsSmall.png">
    </a>
